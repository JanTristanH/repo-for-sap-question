		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IDM C02 Popover Demo",
									"targetURL": "#idmco2popoverdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idmco2popoverdemo-display": {
								"semanticObject": "idmco2popoverdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idmco2popoverdemo",
									"url": sap.ui.require.toUrl("idmco2popoverdemo")
								}
							}
						}
					}
